document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Khafa XD"");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 Khafa XD. All rights reserved.");
        setContent('header', 'textContent', settings.name || "Khafa XDI");
        setContent('name', 'textContent', settings.name || "Khafa XD");
